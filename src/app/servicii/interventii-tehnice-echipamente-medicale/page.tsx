...
const page = getSeoCommercialLandingByPath("/servicii/interventii-tehnice-echipamente-medicale")!;
...
export default function InterventiiTehniceEchipamenteMedicalePage() {
