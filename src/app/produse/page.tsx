            ...
            {displayProducts.length > 0 ? (
              ...
              <div className="mt-8 rounded-2xl border border-blue-100 bg-[#f8fbff] p-6">
                <h2 className="text-xl font-semibold text-slate-950">
                  Catalogul online este in revizuire tehnica.
                </h2>
                <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-600">
                  Pentru a evita afisarea unor produse incomplete sau neverificate, selectia publica este temporar
                  limitata. Trimite aplicatia clinica, categoria de echipament si termenul dorit, iar echipa ZESCORP
                  poate pregati o selectie potrivita pentru ofertare.
                </p>
                <Link
