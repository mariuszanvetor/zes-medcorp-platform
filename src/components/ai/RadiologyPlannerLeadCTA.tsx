...
export function RadiologyPlannerLeadCTA({
  ...
  return (
    <LeadCaptureForm
      description="Validați camera înainte ca ecranarea, aparatura sau autorizarea să blocheze proiectul. Pentru RMN discutăm RF shielding; pentru CT/RX discutăm protecție radiologică."
      extraFields={[
        { id: "projectType", label: "Tip echipament", placeholder: "CT, RMN, RX..." },
      ]}
      eyebrow="Verificare tehnică radiologie"
      ...
      submitLabel="Solicitați verificarea tehnică"
      summary={summary}
      title="Transformați rezultatul plannerului într-o verificare tehnică ZES."
      tone="dark"
    />
  );
}
